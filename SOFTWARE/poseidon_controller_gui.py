...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.run_custom_rates_BTN = QtWidgets.QPushButton(self.control)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.run_custom_rates_BTN.sizePolicy().hasHeightForWidth())
        self.run_custom_rates_BTN.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        self.run_custom_rates_BTN.setFont(font)
        self.run_custom_rates_BTN.setObjectName("run_custom_rates_BTN")
        self.horizontalLayout_11.addWidget(self.run_custom_rates_BTN)
        ...
        self.custom_rates_CHECKBOX = QtWidgets.QCheckBox(self.setup)
        self.custom_rates_CHECKBOX.setObjectName("custom_rates_CHECKBOX")
        self.horizontalLayout_18.addWidget(self.custom_rates_CHECKBOX)
        self.custom_rates_TEXT = QtWidgets.QLineEdit(self.setup)
        self.custom_rates_TEXT.setText("")
        self.custom_rates_TEXT.setObjectName("custom_rates_TEXT")
        self.horizontalLayout_18.addWidget(self.custom_rates_TEXT)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.run_custom_rates_BTN.setText(_translate("MainWindow", "Run Custom"))
        ...
        self.custom_rates_CHECKBOX.setText(_translate("MainWindow", "Custom Rates?"))
        self.custom_rates_TEXT.setPlaceholderText(_translate("MainWindow", "[units (string), delta time [s] (int), flowrate1 (float), flowrate2 (float), ...]"))
