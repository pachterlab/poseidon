...
<h2 align="center">
  Our preprint is now available on the bioRxiv!
</h2>

<h4 align="center">
  Design principles for open source bioinstrumentation: 
  the poseidon syringe pump system as an example.
</h4>
...
- Bill of materials with prices and vendor links on a [Google Spreadheet](https://docs.google.com/spreadsheets/d/1AHBLf0PbtGDgqNbbK6QO31s7ES9_1uCw_NeKWHHPTM4/edit?usp=sharing).
...
Running poseidon: https://youtu.be/Szg-vjukonA
...
#### Note 1: Basic tests indicate that pressures up to 4 MPa can be acheived with 1 microstep and a 1 mL syringe.

#### Note 2: The speeds and flow rates of the system are limited by the microstepping and the syringe size used.
