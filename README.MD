...
Before using the poseidon system in a wetlab environment, please ensure that you have thoroughly tested its functionality for your use case in a dry lab. Once the poseidon system is in a wetlab environment, refrain from removing it to decrease the likelihood of contamination.
